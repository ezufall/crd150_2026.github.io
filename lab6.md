...
We will be working with census tract data on the foreign-born population in Sacramento city.  We first need to get foreign-born population data for California census tracts from the 2019-2023 American Community Survey. Let's use our best friends the Census API and the function `get_acs()`. Remember that "E" at the end of the variable indicates "Estimate" and "M" indicates margins of errors. We won't go through what the code is doing as all the functions have been covered in past labs. See [Lab 3](https://ezufall.github.io/crd150_2026.github.io/lab3.html#Using_the_Census_API) for grabbing ACS data from the Census API, and [Lab 2](https://ezufall.github.io/crd150_2026.github.io/lab2.html#Data_Wrangling) (and [Lab 3](https://ezufall.github.io/crd150_2026.github.io/lab3.html#Data_Wrangling)) for data wrangling functions. We learned about getting spatial data from `get_acs()` in [Lab 5](https://ezufall.github.io/crd150_2026.github.io/lab5.html#tidycensus).
...
Next, let's bring in the Sacramento City boundary using `places()` from the **tigris** package, which we first learned about in [Lab 5](https://ezufall.github.io/crd150_2026.github.io/lab5.html#tigris_package). Remember, since we brought in 2019-2023 ACS data above, you need to specify `year = 2023` in the `places()` function.
...
<center>
![Tracts falling in (County) and out (City) of boundaries](example1.png)
...
``` r
sac.city.tracts <- ms_clip(target = ca.tracts, 
                           clip = sac.city, 
                           remove_slivers = TRUE)
```
...
<center>
![Geographic contiguity](fig1.png)
...
The average number of neighbors (i.e. adjacent tracts) is 5.65, 1 tract has a low of 1 neighbor and 1 has a high of 12 neighbors. What is the modal number of neighbors?
...
<center>
![Los Angeles county tracts with islands](lacounty.png)
