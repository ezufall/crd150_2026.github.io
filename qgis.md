...
<center>
![Figure 1: Windows QGIS Installation Wizard](pic1.JPG)
...
<center>
![Figure 2: Mac QGIS Installation Window](pic2.png)
...
<center>
![Figure 3: Mac QGIS Download package](image1.png)
...
<center>
![Figure 4: QGIS Interface.](Capture2.jpg)
...
3. You can bring up the Data Source Manager by also clicking on ![](Capture3.jpg) typically located in the Toolbars menu.
4. You can add a shapefile by clicking on the ![](pic4.JPG) button, typically located in the Toolbars menu.

Let's use the Data Source Manager approach. When you open up the Data Source Manager, you should get the following window

<center>
![Figure 5: Data Source Manager](pic3.JPG)
...
1. Select  ![](Capture5.jpg) on the left panel. This should bring a screen shown in Figure 6.

<center>
![Figure 6: Adding Vector Data](pic6.JPG)

</center>

2. Under Source and next to Vector Dataset(s), click on ![](Capture17.jpg) at the far right.  
...
![Figure 6: Click on the shapefile](Capture18.jpg)

</center>


4. Click on the Add button ![](Capture7.jpg) and close the Data Source Manager.  You should see tracts in Sacramento county pop up (Figure 7). It may have come in as a different color. 

<center>
![Figure 7: Sacramento county tracts](pic7.JPG)
...
<center>
![Figure 9: Bringing in a csv file](pic9.JPG)
...
<center>
![Figure 10: Layers panel](Capture11.jpg)
...
<center>
![Figure 11: Right click on a layer](Capture12.jpg)

</center>

2. Click on Properties. 
3. Click on the Joins button ![](Capture13.jpg).  A window should pop up that looks like Figure 12.  


<center>
![Figure 12: Layer properties](pic10.JPG)

</center>

4. Click on ![](Capture14.jpg) located at the bottom.  The Add Vector Join window below should come up.

<center>
![Figure 13: Add Vector Join](pic11.jpg)
...
<center>
![Figure 14: Add Vector Join Settings](pic12.jpg)
...
<center>
![Figure 15: Attribute table](Capture16.jpg)
...
4. For File name, select ![](Capture17.jpg) and navigate to the folder you want to save the new shapefile.  Give your new file the name "Sacramento_County_Tracts_Dems.shp". Click Save.
5. Keep everything else the same.  You should have a window that looks like Figure 16. Click OK.  

<center>
![Figure 16: Saving your shapefile](pic13.jpg)
...
2. Select the Symbology button ![](Capture23.jpg) on the left panel.   
...
<center>
![Figure 17: Symbology setup](pic14.jpg)
...
<center>
![Figure 18: Map showing percent poverty in quintiles](pic15.jpg)
...
<center>
![Figure 20: Map layout screen](pic17.jpg)
...
<center>
![Figure 21: Adding your map](pic18.jpg)
...
8. The scale and extent of the map shown in the Map Layout will match what is shown in the main interface. The extent controls movement West, East, North and South.  Scale controls zooming in and out. Toggle back to the main QGIS interface. If you want to make the map bigger or smaller in the Map Layout window, you can change the scale from the Status bar in the main interface.  For example, the current scale I have in the main interface is ![](Capture26.jpg).  I can zoom in a little more - I can do this by using the ![](Capture27.jpg) tool or just type a scale in directly to the scale box.  I do the latter by typing in, for example, 1:300000 and pressing enter.

9. Toggle to the Map Layout window. You will notice that nothing has changed. The scale in the Map Layout window will **not** update - you will have to do it manually.  Click anywhere on your map in the Map Layout window. On the right  panel of the window, click  Item Properties, click on the button ![](qgisextent.png).  See Figure 22. 

<center>
![Figure 22: Set to map canas extent](pic19.png)

</center>

If you move the position of Sacramento West, East, North or South in the main interface, you update the Map Layout by clicking on the Set Map Extent to Match Main Canvas Extent button ![](mapextent.png)
...
<center>
![Figure 23: Scale of 1:350912](pic20.jpg)

</center>

<center>
![Figure 24: Scale of 1:300000](pic21.jpg)
...
<center>
![Figure 25: Adding a legend](pic22.jpg)
...
<center>
![Figure 26: Legend items in Layout screen](Capture32.jpg)
...
<center>
![Figure 27: Map with legend and scale bar](pic23.jpg)
...
<center>
![Figure 28: Picking a north arrow](Capture34.jpg)

</center>

5. If you don't like the default arrow, select your favorite image.  

After selecting it, you can customize as you see fit.  For example, I kept the default arrow ![](pic24.jpg) but altered the properties to make it look like ![](Capture39.png)
...
<center>
![Figure 29: Map with the accoutrements](qgisfinalmap1.jpeg)
...
<center>
![Figure 30: Selecting OpenStreetMap basemap](pic31.jpg)
...
<center>
![Figure 31: Changing the ordering through the Layers panel](pic26a.png)
...
2. Scroll down to Legend Items and unclick Auto Update ![](autoupdate.png).  
3. In the Legend Items window, click on the OpenStreetMap layer. 
4. Below the Legend Items window, click on ![](legenddelete.png). The OpenStreetMap layer should no longer be in the legend.

You can further customize the map as you see fit.  I ended up with the map shown in the figure below.

<center>
![Figure 32: Map with OpenStreetMap basemap](qgisfinalmap.jpeg)
