...
library(sf)
library(tidyverse)
dt <- read_csv("agenda.csv")
kable(dt) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>%
    column_spec(2, width = "5em") %>%
    column_spec(5, width = "13em") %>% 
    row_spec(3, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(6, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(9, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(12, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(15, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(18, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(21, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(24, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(27, extra_css = "border-bottom: 3px solid #000;") %>% 
  row_spec(30, extra_css = "border-bottom: 3px solid #000;") 
```
